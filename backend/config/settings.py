...
SETTINGS = {
    ...
    # already are, so rule-management tests never touch the real
    # backend/config/ directory or its checked-in example_client ruleset.
    "rules_config_dir": REPO_ROOT / "backend" / "config",
    # Scoring
    "dimensions": [
        "completeness",
        "validity",
