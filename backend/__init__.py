...
Milestone 1 (Foundations) lives here:
    ...
    - logging/      Structured JSONL logs + run manifests
...
from backend.services.rules import RuleResolver
from backend.services.rules import init_rule_resolver as _build_rule_resolver
