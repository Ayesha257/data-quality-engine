...
pipeline, exactly like every other module in data_quality_engine/. Adding
...
from data_quality_engine.phase2.api.headless_prompt import HeadlessPrompt
...
def _mark_completed(
    ...
    *,
    ...
    from data_quality_engine.phase2.database.models import _utcnow  # shared monotonic clock
...
def _write_manifest(run_id: str, outcomes: list[dict[str, Any]]) -> None:
    from data_quality_engine.phase2.database.models import RunManifest
        ...
        checks_run = sorted(
            {
                ...
                "fuzzy_standardization", "schema_quality", "consistency", "validity",
                "freshness", "scoring",
            }
        )
